...
(function(process) {
  ...
  System.config({"map": {
      ...
      "github:floatdrop/plugin-jsx@0.1.1": {"react-tools": "npm:react-tools@0.12.2"},
      "github:jspm/nodelibs-assert@0.1.0": {"assert": "npm:assert@1.3.0"},
      "github:jspm/nodelibs-buffer@0.1.0": {"buffer": "npm:buffer@3.0.2"},
      "github:jspm/nodelibs-constants@0.1.0": {"constants-browserify": "npm:constants-browserify@0.0.1"},
      "github:jspm/nodelibs-crypto@0.1.0": {"crypto-browserify": "npm:crypto-browserify@3.9.12"},
      "github:jspm/nodelibs-events@0.1.0": {"events-browserify": "npm:events-browserify@0.0.1"},
      ...
      "github:jspm/nodelibs-url@0.1.0": {"url": "npm:url@0.10.2"},
      ...
      "npm:asn1.js-rfc3280@1.0.0": {"asn1.js": "npm:asn1.js@1.0.3"},
      "npm:asn1.js@1.0.3": {
      ...
      "npm:constants-browserify@0.0.1": {"systemjs-json": "github:systemjs/plugin-json@0.1.0"},
      ...
      "npm:events-browserify@0.0.1": {"process": "github:jspm/nodelibs-process@0.1.1"},
      "npm:faye-websocket@0.9.2": {
        "buffer": "github:jspm/nodelibs-buffer@0.1.0",
        "crypto": "github:jspm/nodelibs-crypto@0.1.0",
        "fs": "github:jspm/nodelibs-fs@0.1.1",
        ...
        "url": "github:jspm/nodelibs-url@0.1.0",
        "util": "github:jspm/nodelibs-util@0.1.0",
        "websocket-driver": "npm:websocket-driver@0.5.1"
      },
      "npm:firebase@2.2.0": {
        "buffer": "github:jspm/nodelibs-buffer@0.1.0",
        "faye-websocket": "npm:faye-websocket@0.9.2",
        "http": "github:jspm/nodelibs-http@1.7.0",
        "https": "github:jspm/nodelibs-https@0.1.0",
        "process": "github:jspm/nodelibs-process@0.1.1"
      },
      ...
      "npm:hash.js@1.0.2": {"inherits": "npm:inherits@2.0.1"},
      "npm:https-browserify@0.0.0": {"http": "github:jspm/nodelibs-http@1.7.0"},
      ...
      "npm:once@1.3.1": {"wrappy": "npm:wrappy@1.0.1"},
      ...
      "npm:path-browserify@0.0.0": {"process": "github:jspm/nodelibs-process@0.1.1"},
      ...
      "npm:q@1.1.2": {"process": "github:jspm/nodelibs-process@0.1.1"},
      "npm:ramda@0.10.0": {"process": "github:jspm/nodelibs-process@0.1.1"},
      ...
      "npm:websocket-driver@0.5.1": {
        ...
        "url": "github:jspm/nodelibs-url@0.1.0",
        "util": "github:jspm/nodelibs-util@0.1.0",
        "websocket-extensions": "npm:websocket-extensions@0.1.0"
      },
      "npm:websocket-extensions@0.1.0": {"process": "github:jspm/nodelibs-process@0.1.1"}
    }});
})(require("process"));
